...
const home = ({ data }) => {
  ...
  return (
    <Layout title={"Countries API"}>
      ...
      <span className="font-semibold" >Coded by <a href="#" className="text-custom_white">Marko</a>. You can find the github repo <a href="" className="text-custom_white">here.</a></span>
      </div>
