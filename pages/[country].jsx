                ...
                <div className="py-8 text-custom_white">
                    ...
                    <div className="flex gap-4 my-8 flex-col md:flex-row w-full">
                        <div className="md:w-3/6 w-full">
                            ...
                            <h3 className="my-2"> <span className="font-semibold"> Region : </span> {data[0].region}  </h3>
                            <h3 className="my-2"> <span className="font-semibold"> Subregion : </span> {data[0].subregion}  </h3>
                            <h3 className="my-2"> <span className="font-semibold"> Capital : </span> {
                                data[0].capital ? data[0].capital : null
                            }  </h3>
                        </div>
                        <div className="md:w-3/6 w-full">
